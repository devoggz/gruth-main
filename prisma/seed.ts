...
const SOURCES_BY_COUNTY: Record<string, { name: string; url?: string }[]> = {
    Nairobi:  [
        ...
        { name: "Mastermind Hardware — Ngong Road", url: "https://mastermind.co.ke"    },
...
const PRICE_DATA: Record<string, Record<string, PriceRange>> = {
    // Cement & Concrete
    "Bamburi Cement 50kg":          { Nairobi:[680,720],  Kiambu:[700,740],  Mombasa:[730,770],  Nakuru:[710,750],  Kisumu:[720,760],  Machakos:[700,740],  Eldoret:[720,760],  Nyeri:[710,750]  },
    "Savannah Cement 50kg":         { Nairobi:[660,700],  Kiambu:[680,720],  Mombasa:[710,750],  Nakuru:[690,730],  Kisumu:[700,740],  Machakos:[680,720],  Eldoret:[700,740],  Nyeri:[690,730]  },
    "East African Portland Cement": { Nairobi:[650,690],  Kiambu:[670,710],  Mombasa:[700,740],  Nakuru:[680,720],  Kisumu:[690,730],  Machakos:[670,710],  Eldoret:[690,730],  Nyeri:[680,720]  },
    "Ballast (20mm)":               { Nairobi:[4500,5500],Kiambu:[3800,4800],Mombasa:[5000,6200],Nakuru:[4000,5000],Kisumu:[4200,5200],Machakos:[4000,5000],Eldoret:[4200,5200],Nyeri:[4000,5000] },
    "Concrete Blocks 6 inch":       { Nairobi:[65,80],    Kiambu:[60,75],    Mombasa:[70,85],    Nakuru:[62,78],    Kisumu:[63,79],    Machakos:[62,78],    Eldoret:[63,79],    Nyeri:[62,78]    },
    "Concrete Blocks 9 inch":       { Nairobi:[85,105],   Kiambu:[82,102],   Mombasa:[92,112],   Nakuru:[84,104],   Kisumu:[85,105],   Machakos:[83,103],   Eldoret:[85,105],   Nyeri:[83,103]   },
    "Precast Lintels (1.5m)":       { Nairobi:[380,480],  Kiambu:[360,460],  Mombasa:[420,520],  Nakuru:[370,470],  Kisumu:[380,480],  Machakos:[370,470],  Eldoret:[375,475],  Nyeri:[370,470]  },
    // Steel & Metal
    "Y8 Steel Rebar (6m)":          { Nairobi:[380,420],  Kiambu:[390,430],  Mombasa:[410,450],  Nakuru:[395,435],  Kisumu:[400,440],  Machakos:[395,435],  Eldoret:[400,440],  Nyeri:[395,435]  },
    "Y10 Steel Rebar (6m)":         { Nairobi:[560,620],  Kiambu:[570,630],  Mombasa:[590,650],  Nakuru:[565,625],  Kisumu:[570,630],  Machakos:[565,625],  Eldoret:[570,630],  Nyeri:[565,625]  },
    "Y12 Steel Rebar (6m)":         { Nairobi:[780,860],  Kiambu:[790,870],  Mombasa:[820,900],  Nakuru:[785,865],  Kisumu:[795,875],  Machakos:[785,865],  Eldoret:[795,875],  Nyeri:[785,865]  },
    "Y16 Steel Rebar (6m)":         { Nairobi:[1380,1520],Kiambu:[1400,1540],Mombasa:[1450,1590],Nakuru:[1390,1530],Kisumu:[1400,1540],Machakos:[1390,1530],Eldoret:[1400,1540],Nyeri:[1390,1530] },
    "Y20 Steel Rebar (6m)":         { Nairobi:[2200,2480],Kiambu:[2240,2520],Mombasa:[2320,2600],Nakuru:[2210,2490],Kisumu:[2220,2500],Machakos:[2210,2490],Eldoret:[2220,2500],Nyeri:[2210,2490] },
    "BRC Mesh A142":                { Nairobi:[2800,3200],Kiambu:[2850,3250],Mombasa:[3000,3400],Nakuru:[2900,3300],Kisumu:[2920,3320],Machakos:[2900,3300],Eldoret:[2920,3320],Nyeri:[2900,3300] },
    "Iron Sheets (28 gauge 8ft)":   { Nairobi:[850,950],  Kiambu:[870,970],  Mombasa:[920,1020], Nakuru:[880,980],  Kisumu:[890,990],  Machakos:[880,980],  Eldoret:[890,990],  Nyeri:[880,980]  },
    "Iron Sheets (30 gauge 8ft)":   { Nairobi:[680,780],  Kiambu:[700,800],  Mombasa:[740,840],  Nakuru:[710,810],  Kisumu:[720,820],  Machakos:[710,810],  Eldoret:[720,820],  Nyeri:[710,810]  },
    "Galvanised Nails 4 inch":      { Nairobi:[160,200],  Kiambu:[165,205],  Mombasa:[175,215],  Nakuru:[165,205],  Kisumu:[168,208],  Machakos:[165,205],  Eldoret:[168,208],  Nyeri:[165,205]  },
    "Roofing Nails 3 inch":         { Nairobi:[140,180],  Kiambu:[145,185],  Mombasa:[155,195],  Nakuru:[145,185],  Kisumu:[148,188],  Machakos:[145,185],  Eldoret:[148,188],  Nyeri:[145,185]  },
    // Sand & Aggregates
    "River Sand":                   { Nairobi:[3500,4500],Kiambu:[3000,4000],Mombasa:[4000,5000],Nakuru:[3200,4200],Kisumu:[3400,4400],Machakos:[3200,4200],Eldoret:[3300,4300],Nyeri:[3200,4200] },
    "Quarry Dust":                  { Nairobi:[2500,3500],Kiambu:[2200,3200],Mombasa:[3000,4000],Nakuru:[2400,3400],Kisumu:[2500,3500],Machakos:[2400,3400],Eldoret:[2500,3500],Nyeri:[2400,3400] },
    "Hardcore":                     { Nairobi:[2000,2800],Kiambu:[1800,2600],Mombasa:[2400,3200],Nakuru:[1900,2700],Kisumu:[2000,2800],Machakos:[1900,2700],Eldoret:[2000,2800],Nyeri:[1900,2700] },
    "Crusher Run":                  { Nairobi:[2800,3500],Kiambu:[2500,3200],Mombasa:[3200,4000],Nakuru:[2700,3400],Kisumu:[2800,3500],Machakos:[2700,3400],Eldoret:[2800,3500],Nyeri:[2700,3400] },
    "Building Sand":                { Nairobi:[3200,4200],Kiambu:[2900,3900],Mombasa:[3800,4800],Nakuru:[3000,4000],Kisumu:[3200,4200],Machakos:[3000,4000],Eldoret:[3100,4100],Nyeri:[3000,4000] },
    // Timber & Roofing
    "3x2 Timber (12ft)":            { Nairobi:[420,520],  Kiambu:[400,500],  Mombasa:[460,560],  Nakuru:[410,510],  Kisumu:[420,520],  Machakos:[410,510],  Eldoret:[415,515],  Nyeri:[410,510]  },
    "2x2 Timber (12ft)":            { Nairobi:[280,360],  Kiambu:[270,350],  Mombasa:[310,390],  Nakuru:[275,355],  Kisumu:[280,360],  Machakos:[275,355],  Eldoret:[278,358],  Nyeri:[275,355]  },
    "4x2 Timber (12ft)":            { Nairobi:[580,720],  Kiambu:[560,700],  Mombasa:[630,780],  Nakuru:[570,710],  Kisumu:[580,720],  Machakos:[570,710],  Eldoret:[575,715],  Nyeri:[570,710]  },
    "Marine Plywood (18mm)":        { Nairobi:[3200,3800],Kiambu:[3000,3600],Mombasa:[3500,4200],Nakuru:[3100,3700],Kisumu:[3200,3800],Machakos:[3100,3700],Eldoret:[3200,3800],Nyeri:[3100,3700] },
    "Fascia Board (4m)":            { Nairobi:[380,480],  Kiambu:[360,460],  Mombasa:[420,520],  Nakuru:[370,470],  Kisumu:[380,480],  Machakos:[370,470],  Eldoret:[375,475],  Nyeri:[370,470]  },
    "Ridging (8ft)":                { Nairobi:[420,520],  Kiambu:[430,530],  Mombasa:[460,560],  Nakuru:[435,535],  Kisumu:[440,540],  Machakos:[435,535],  Eldoret:[440,540],  Nyeri:[435,535]  },
    // Finishes & Paint
    "Crown Wall Paint 20L":         { Nairobi:[3800,4500],Kiambu:[3900,4600],Mombasa:[4200,4900],Nakuru:[3950,4650],Kisumu:[4000,4700],Machakos:[3950,4650],Eldoret:[4000,4700],Nyeri:[3950,4650] },
    "Sadolin Floor Paint 20L":      { Nairobi:[4500,5500],Kiambu:[4600,5600],Mombasa:[5000,6000],Nakuru:[4700,5700],Kisumu:[4750,5750],Machakos:[4700,5700],Eldoret:[4750,5750],Nyeri:[4700,5700] },
    "Tile Adhesive 20kg":           { Nairobi:[580,720],  Kiambu:[600,740],  Mombasa:[640,780],  Nakuru:[610,750],  Kisumu:[620,760],  Machakos:[610,750],  Eldoret:[620,760],  Nyeri:[610,750]  },
    "Tiles 60x60cm (Ceramic)":      { Nairobi:[1800,2800],Kiambu:[1900,2900],Mombasa:[2100,3100],Nakuru:[1950,2950],Kisumu:[2000,3000],Machakos:[1950,2950],Eldoret:[2000,3000],Nyeri:[1950,2950] },
    "Tiles 30x30cm (Anti-slip)":    { Nairobi:[1200,1800],Kiambu:[1250,1850],Mombasa:[1400,2000],Nakuru:[1280,1880],Kisumu:[1300,1900],Machakos:[1280,1880],Eldoret:[1300,1900],Nyeri:[1280,1880] },
    "Waterproofing Compound 5L":    { Nairobi:[1200,1600],Kiambu:[1250,1650],Mombasa:[1400,1800],Nakuru:[1280,1680],Kisumu:[1300,1700],Machakos:[1280,1680],Eldoret:[1300,1700],Nyeri:[1280,1680] },
    "Skim Coat / Finishing Plaster":{ Nairobi:[680,880],  Kiambu:[700,900],  Mombasa:[760,960],  Nakuru:[710,910],  Kisumu:[720,920],  Machakos:[710,910],  Eldoret:[720,920],  Nyeri:[710,910]  },
    // Hardware & Fixings
    "PVC Pipe 4 inch (6m)":         { Nairobi:[1400,1800],Kiambu:[1450,1850],Mombasa:[1600,2000],Nakuru:[1480,1880],Kisumu:[1500,1900],Machakos:[1480,1880],Eldoret:[1500,1900],Nyeri:[1480,1880] },
    "GI Pipe 1 inch (6m)":          { Nairobi:[1200,1600],Kiambu:[1250,1650],Mombasa:[1400,1800],Nakuru:[1280,1680],Kisumu:[1300,1700],Machakos:[1280,1680],Eldoret:[1300,1700],Nyeri:[1280,1680] },
    "PPR Pipe 20mm (4m)":           { Nairobi:[380,520],  Kiambu:[390,530],  Mombasa:[430,570],  Nakuru:[395,535],  Kisumu:[400,540],  Machakos:[395,535],  Eldoret:[400,540],  Nyeri:[395,535]  },
    "Door Hinges 4 inch (pair)":    { Nairobi:[180,260],  Kiambu:[185,265],  Mombasa:[200,280],  Nakuru:[185,265],  Kisumu:[190,270],  Machakos:[185,265],  Eldoret:[190,270],  Nyeri:[185,265]  },
    "Padlock 60mm":                 { Nairobi:[650,950],  Kiambu:[670,970],  Mombasa:[750,1050], Nakuru:[680,980],  Kisumu:[700,1000], Machakos:[680,980],  Eldoret:[700,1000], Nyeri:[680,980]  },
    "Electrical Cable 2.5mm (50m)": { Nairobi:[3800,4800],Kiambu:[3900,4900],Mombasa:[4200,5200],Nakuru:[3950,4950],Kisumu:[4000,5000],Machakos:[3950,4950],Eldoret:[4000,5000],Nyeri:[3950,4950] },
    "MCB Circuit Breaker 20A":      { Nairobi:[380,520],  Kiambu:[390,530],  Mombasa:[430,570],  Nakuru:[395,535],  Kisumu:[400,540],  Machakos:[395,535],  Eldoret:[400,540],  Nyeri:[395,535]  },
};
