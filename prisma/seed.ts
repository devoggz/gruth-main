...
const SOURCES_BY_COUNTY: Record<string, { name: string; url?: string }[]> = {
  ...
  Meru: [
    { name: "Meru Hardware & Timber" },
    { name: "GRUTH Field Survey — Meru" },
  ],
  Embu: [
    { name: "Embu Building Materials" },
    { name: "GRUTH Field Survey — Embu" },
  ],
  Kisii: [
    { name: "Kisii Hardware Centre" },
    { name: "GRUTH Field Survey — Kisii" },
  ],
  Kakamega: [
    { name: "Kakamega Hardware Supplies" },
    { name: "GRUTH Field Survey — Kakamega" },
  ],
  Bungoma: [
    { name: "Bungoma Hardware Depot" },
    { name: "GRUTH Field Survey — Bungoma" },
  ],
  Kitui: [
    { name: "Kitui Building Supplies" },
    { name: "GRUTH Field Survey — Kitui" },
  ],
  Kajiado: [
    { name: "Kajiado Hardware Centre" },
    { name: "GRUTH Field Survey — Kajiado" },
  ],
  Narok: [
    { name: "Narok Hardware Depot" },
    { name: "GRUTH Field Survey — Narok" },
  ],
...
const PRICE_DATA: Record<string, Record<string, PriceRange>> = {
  ...
  "Bamburi Cement 50kg": {
    ...
    "Tana River": [760, 800],
    Lamu: [780, 820],
    "Taita Taveta": [745, 785],
    Garissa: [760, 800],
    Wajir: [800, 840],
    Mandera: [820, 860],
    Marsabit: [790, 830],
    Isiolo: [750, 790],
    "Tharaka-Nithi": [718, 758],
    Makueni: [708, 748],
    Nyandarua: [712, 752],
    Kirinyaga: [708, 748],
    "Murang'a": [704, 744],
  ...
  "Savannah Cement 50kg": {
    ...
    "Tana River": [740, 780],
    Lamu: [760, 800],
    "Taita Taveta": [725, 765],
    Garissa: [740, 780],
    Wajir: [780, 820],
    Mandera: [800, 840],
    Marsabit: [770, 810],
    Isiolo: [730, 770],
    "Tharaka-Nithi": [698, 738],
    Makueni: [688, 728],
    Nyandarua: [692, 732],
    Kirinyaga: [688, 728],
    "Murang'a": [684, 724],
  ...
  "East African Portland Cement": {
    ...
    "Tana River": [730, 770],
    Lamu: [750, 790],
    "Taita Taveta": [715, 755],
    Garissa: [730, 770],
    Wajir: [770, 810],
    Mandera: [790, 830],
    Marsabit: [760, 800],
    Isiolo: [720, 760],
    "Tharaka-Nithi": [688, 728],
    Makueni: [678, 718],
    Nyandarua: [682, 722],
    Kirinyaga: [678, 718],
    "Murang'a": [674, 714],
  ...
  "Ballast (20mm)": {
    ...
    Kwale: [5200, 6400],
    Kilifi: [5100, 6200],
    "Tana River": [5500, 6800],
    Lamu: [6000, 7500],
    "Taita Taveta": [4800, 5900],
    Garissa: [5500, 6800],
    Wajir: [6000, 7500],
    Mandera: [6500, 8000],
    Marsabit: [5800, 7200],
    Isiolo: [4800, 5900],
    "Tharaka-Nithi": [4000, 5000],
    Makueni: [4100, 5100],
    Nyandarua: [3900, 4900],
    Kirinyaga: [3800, 4800],
    "Murang'a": [3800, 4800],
    Turkana: [6500, 8000],
    "West Pokot": [5500, 6800],
    Samburu: [5600, 7000],
    "Trans-Nzoia": [4200, 5200],
    "Elgeyo-Marakwet": [4300, 5300],
    Nandi: [4100, 5100],
    Baringo: [4500, 5500],
    Laikipia: [4200, 5200],
    Kericho: [4100, 5100],
  ...
  "Precast Lintels (1.5m)": {
    ...
    "Tana River": [450, 550],
    Lamu: [480, 580],
    "Taita Taveta": [420, 520],
    Garissa: [450, 550],
    Wajir: [490, 590],
    Mandera: [520, 620],
    Marsabit: [475, 575],
    Isiolo: [405, 505],
    "Tharaka-Nithi": [372, 472],
    Makueni: [370, 470],
    Nyandarua: [368, 468],
    Kirinyaga: [365, 465],
    "Murang'a": [365, 465],
  ...
  "Y8 Steel Rebar (6m)": {
    ...
    "Tana River": [435, 475],
    Lamu: [450, 490],
    "Taita Taveta": [415, 455],
    Garissa: [435, 475],
    Wajir: [460, 500],
    Mandera: [480, 520],
    Marsabit: [452, 492],
    Isiolo: [415, 455],
    "Tharaka-Nithi": [397, 437],
    Makueni: [393, 433],
    Nyandarua: [394, 434],
    Kirinyaga: [392, 432],
    "Murang'a": [391, 431],
  ...
  "Y10 Steel Rebar (6m)": {
    ...
    "Tana River": [625, 685],
    Lamu: [648, 708],
    "Taita Taveta": [595, 655],
    Garissa: [625, 685],
    Wajir: [660, 720],
    Mandera: [690, 750],
    Marsabit: [652, 712],
    Isiolo: [590, 650],
    "Tharaka-Nithi": [568, 628],
    Makueni: [564, 624],
    Nyandarua: [565, 625],
    Kirinyaga: [563, 623],
    "Murang'a": [562, 622],
  ...
  "Y12 Steel Rebar (6m)": {
    ...
    "Tana River": [865, 945],
    Lamu: [895, 975],
    "Taita Taveta": [828, 908],
    Garissa: [865, 945],
    Wajir: [915, 995],
    Mandera: [955, 1035],
    Marsabit: [902, 982],
    Isiolo: [818, 898],
    "Tharaka-Nithi": [788, 868],
    Makueni: [784, 864],
    Nyandarua: [785, 865],
    Kirinyaga: [783, 863],
    "Murang'a": [782, 862],
  ...
  "Y16 Steel Rebar (6m)": {
    ...
    Kwale: [1485, 1625],
    Kilifi: [1478, 1618],
    "Tana River": [1532, 1672],
    Lamu: [1585, 1725],
    "Taita Taveta": [1465, 1605],
    Garissa: [1532, 1672],
    Wajir: [1620, 1760],
    Mandera: [1695, 1835],
    Marsabit: [1598, 1738],
    Isiolo: [1450, 1590],
    "Tharaka-Nithi": [1395, 1535],
    Makueni: [1388, 1528],
    Nyandarua: [1392, 1532],
    Kirinyaga: [1388, 1528],
    "Murang'a": [1385, 1525],
    Turkana: [1712, 1852],
    "West Pokot": [1495, 1635],
    Samburu: [1520, 1660],
    "Trans-Nzoia": [1408, 1548],
    "Elgeyo-Marakwet": [1412, 1552],
    Nandi: [1405, 1545],
    Baringo: [1425, 1565],
    Laikipia: [1410, 1550],
    Kericho: [1400, 1540],
  ...
  "Y20 Steel Rebar (6m)": {
    ...
    Kwale: [2368, 2648],
    Kilifi: [2352, 2632],
    "Tana River": [2440, 2720],
    Lamu: [2528, 2808],
    "Taita Taveta": [2338, 2618],
    Garissa: [2440, 2720],
    Wajir: [2580, 2860],
    Mandera: [2700, 2980],
    Marsabit: [2548, 2828],
    Isiolo: [2310, 2590],
    "Tharaka-Nithi": [2215, 2495],
    Makueni: [2208, 2488],
    Nyandarua: [2212, 2492],
    Kirinyaga: [2208, 2488],
    "Murang'a": [2205, 2485],
    Turkana: [2728, 3008],
    "West Pokot": [2382, 2662],
    Samburu: [2420, 2700],
    "Trans-Nzoia": [2232, 2512],
    "Elgeyo-Marakwet": [2238, 2518],
    Nandi: [2228, 2508],
    Baringo: [2268, 2548],
    Laikipia: [2238, 2518],
    Kericho: [2222, 2502],
  ...
  "BRC Mesh A142": {
    ...
    Kwale: [3080, 3480],
    Kilifi: [3060, 3460],
    "Tana River": [3180, 3580],
    Lamu: [3290, 3690],
    "Taita Taveta": [3040, 3440],
    Garissa: [3180, 3580],
    Wajir: [3360, 3760],
    Mandera: [3510, 3910],
    Marsabit: [3318, 3718],
    Isiolo: [3010, 3410],
    "Tharaka-Nithi": [2910, 3310],
    Makueni: [2902, 3302],
    Nyandarua: [2905, 3305],
    Kirinyaga: [2900, 3300],
    "Murang'a": [2898, 3298],
    Turkana: [3552, 3952],
    "West Pokot": [3102, 3502],
    Samburu: [3152, 3552],
    "Trans-Nzoia": [2932, 3332],
    "Elgeyo-Marakwet": [2940, 3340],
    Nandi: [2928, 3328],
    Baringo: [2970, 3370],
    Laikipia: [2938, 3338],
    Kericho: [2922, 3322],
  ...
  "Iron Sheets (28 gauge 8ft)": {
    ...
    "Tana River": [970, 1070],
    Lamu: [1005, 1105],
    "Taita Taveta": [928, 1028],
    Garissa: [970, 1070],
    Wajir: [1028, 1128],
    Mandera: [1072, 1172],
    Marsabit: [1012, 1112],
    Isiolo: [922, 1022],
    "Tharaka-Nithi": [885, 985],
    Makueni: [880, 980],
    Nyandarua: [882, 982],
    Kirinyaga: [880, 980],
    "Murang'a": [878, 978],
  ...
  "Iron Sheets (30 gauge 8ft)": {
    ...
    "Tana River": [780, 880],
    Lamu: [808, 908],
    "Taita Taveta": [748, 848],
    Garissa: [780, 880],
    Wajir: [825, 925],
    Mandera: [862, 962],
    Marsabit: [814, 914],
    Isiolo: [752, 852],
    "Tharaka-Nithi": [715, 815],
    Makueni: [710, 810],
    Nyandarua: [712, 812],
    Kirinyaga: [710, 810],
    "Murang'a": [708, 808],
  ...
  "Galvanised Nails 4 inch": {
    ...
    "Tana River": [185, 225],
    Lamu: [192, 232],
    "Taita Taveta": [178, 218],
    Garissa: [185, 225],
    Wajir: [196, 236],
    Mandera: [205, 245],
    Marsabit: [194, 234],
    Isiolo: [174, 214],
    "Tharaka-Nithi": [166, 206],
    Makueni: [164, 204],
    Nyandarua: [165, 205],
    Kirinyaga: [164, 204],
    "Murang'a": [164, 204],
  ...
  "Roofing Nails 3 inch": {
    ...
    "Tana River": [165, 205],
    Lamu: [172, 212],
    "Taita Taveta": [158, 198],
    Garissa: [165, 205],
    Wajir: [175, 215],
    Mandera: [183, 223],
    Marsabit: [173, 213],
    Isiolo: [154, 194],
    "Tharaka-Nithi": [146, 186],
    Makueni: [144, 184],
    Nyandarua: [145, 185],
    Kirinyaga: [144, 184],
    "Murang'a": [144, 184],
  ...
  "River Sand": {
    ...
    Kwale: [4200, 5200],
    Kilifi: [4100, 5100],
    "Tana River": [4600, 5600],
    Lamu: [5200, 6200],
    "Taita Taveta": [4000, 5000],
    Garissa: [4600, 5600],
    Wajir: [5500, 6500],
    Mandera: [6000, 7000],
    Marsabit: [5200, 6200],
    Isiolo: [3900, 4900],
    "Tharaka-Nithi": [3100, 4100],
    Makueni: [3200, 4200],
    Nyandarua: [3000, 4000],
    Kirinyaga: [2900, 3900],
    "Murang'a": [2900, 3900],
    Turkana: [6200, 7200],
    "West Pokot": [4400, 5400],
    Samburu: [4600, 5600],
    "Trans-Nzoia": [3500, 4500],
    "Elgeyo-Marakwet": [3500, 4500],
    Nandi: [3400, 4400],
    Baringo: [3600, 4600],
    Laikipia: [3400, 4400],
    Kericho: [3400, 4400],
  ...
  "Quarry Dust": {
    ...
    Kwale: [3100, 4100],
    Kilifi: [3000, 4000],
    "Tana River": [3500, 4500],
    Lamu: [4000, 5000],
    "Taita Taveta": [3000, 4000],
    Garissa: [3500, 4500],
    Wajir: [4200, 5200],
    Mandera: [4600, 5600],
    Marsabit: [4000, 5000],
    Isiolo: [2900, 3900],
    "Tharaka-Nithi": [2300, 3300],
    Makueni: [2400, 3400],
    Nyandarua: [2200, 3200],
    Kirinyaga: [2100, 3100],
    "Murang'a": [2100, 3100],
    Turkana: [4800, 5800],
    "West Pokot": [3300, 4300],
    Samburu: [3500, 4500],
    "Trans-Nzoia": [2600, 3600],
    "Elgeyo-Marakwet": [2600, 3600],
    Nandi: [2500, 3500],
    Baringo: [2700, 3700],
    Laikipia: [2600, 3600],
    Kericho: [2500, 3500],
  ...
  Hardcore: {
    ...
    Kwale: [2500, 3300],
    Kilifi: [2400, 3200],
    "Tana River": [2800, 3600],
    Lamu: [3200, 4000],
    "Taita Taveta": [2300, 3100],
    Garissa: [2800, 3600],
    Wajir: [3400, 4200],
    Mandera: [3800, 4600],
    Marsabit: [3200, 4000],
    Isiolo: [2300, 3100],
    "Tharaka-Nithi": [1850, 2650],
    Makueni: [1900, 2700],
    Nyandarua: [1800, 2600],
    Kirinyaga: [1700, 2500],
    "Murang'a": [1700, 2500],
    Turkana: [3900, 4700],
    "West Pokot": [2600, 3400],
    Samburu: [2700, 3500],
    "Trans-Nzoia": [2100, 2900],
    "Elgeyo-Marakwet": [2100, 2900],
    Nandi: [2000, 2800],
    Baringo: [2150, 2950],
    Laikipia: [2100, 2900],
    Kericho: [2000, 2800],
  ...
  "Crusher Run": {
    ...
    Kwale: [3300, 4100],
    Kilifi: [3200, 4000],
    "Tana River": [3600, 4400],
    Lamu: [4100, 4900],
    "Taita Taveta": [3100, 3900],
    Garissa: [3600, 4400],
    Wajir: [4300, 5100],
    Mandera: [4800, 5600],
    Marsabit: [4100, 4900],
    Isiolo: [3100, 3900],
    "Tharaka-Nithi": [2650, 3350],
    Makueni: [2700, 3400],
    Nyandarua: [2550, 3250],
    Kirinyaga: [2450, 3150],
    "Murang'a": [2450, 3150],
    Turkana: [4900, 5700],
    "West Pokot": [3400, 4200],
    Samburu: [3500, 4300],
    "Trans-Nzoia": [2900, 3600],
    "Elgeyo-Marakwet": [2900, 3600],
    Nandi: [2800, 3500],
    Baringo: [3000, 3700],
    Laikipia: [2900, 3600],
    Kericho: [2800, 3500],
  ...
  "Building Sand": {
    ...
    Kwale: [3900, 4900],
    Kilifi: [3800, 4800],
    "Tana River": [4300, 5300],
    Lamu: [4800, 5800],
    "Taita Taveta": [3700, 4700],
    Garissa: [4300, 5300],
    Wajir: [5100, 6100],
    Mandera: [5600, 6600],
    Marsabit: [4800, 5800],
    Isiolo: [3600, 4600],
    "Tharaka-Nithi": [2950, 3950],
    Makueni: [3000, 4000],
    Nyandarua: [2900, 3900],
    Kirinyaga: [2800, 3800],
    "Murang'a": [2800, 3800],
    Turkana: [5700, 6700],
    "West Pokot": [4100, 5100],
    Samburu: [4300, 5300],
    "Trans-Nzoia": [3300, 4300],
    "Elgeyo-Marakwet": [3300, 4300],
    Nandi: [3200, 4200],
    Baringo: [3400, 4400],
    Laikipia: [3300, 4300],
    Kericho: [3200, 4200],
  ...
  "3x2 Timber (12ft)": {
    ...
    "Tana River": [490, 590],
    Lamu: [515, 615],
    "Taita Taveta": [462, 562],
    Garissa: [490, 590],
    Wajir: [525, 625],
    Mandera: [555, 655],
    Marsabit: [518, 618],
    Isiolo: [445, 545],
    "Tharaka-Nithi": [408, 508],
    Makueni: [410, 510],
    Nyandarua: [404, 504],
    Kirinyaga: [401, 501],
    "Murang'a": [400, 500],
  ...
  "2x2 Timber (12ft)": {
    ...
    "Tana River": [330, 410],
    Lamu: [345, 425],
    "Taita Taveta": [312, 392],
    Garissa: [330, 410],
    Wajir: [350, 430],
    Mandera: [368, 448],
    Marsabit: [348, 428],
    Isiolo: [298, 378],
    "Tharaka-Nithi": [273, 353],
    Makueni: [275, 355],
    Nyandarua: [271, 351],
    Kirinyaga: [269, 349],
    "Murang'a": [268, 348],
  ...
  "4x2 Timber (12ft)": {
    ...
    "Tana River": [668, 808],
    Lamu: [698, 838],
    "Taita Taveta": [632, 772],
    Garissa: [668, 808],
    Wajir: [710, 850],
    Mandera: [748, 888],
    Marsabit: [704, 844],
    Isiolo: [615, 755],
    "Tharaka-Nithi": [568, 708],
    Makueni: [570, 710],
    Nyandarua: [564, 704],
    Kirinyaga: [561, 701],
    "Murang'a": [560, 700],
  ...
  "Marine Plywood (18mm)": {
    ...
    Kwale: [3590, 4190],
    Kilifi: [3560, 4160],
    "Tana River": [3710, 4310],
    Lamu: [3880, 4480],
    "Taita Taveta": [3530, 4130],
    Garissa: [3710, 4310],
    Wajir: [3940, 4540],
    Mandera: [4140, 4740],
    Marsabit: [3912, 4512],
    Isiolo: [3420, 4020],
    "Tharaka-Nithi": [3080, 3680],
    Makueni: [3100, 3700],
    Nyandarua: [3050, 3650],
    Kirinyaga: [3030, 3630],
    "Murang'a": [3020, 3620],
    Turkana: [4182, 4782],
    "West Pokot": [3610, 4210],
    Samburu: [3670, 4270],
    "Trans-Nzoia": [3222, 3822],
    "Elgeyo-Marakwet": [3230, 3830],
    Nandi: [3210, 3810],
    Baringo: [3280, 3880],
    Laikipia: [3225, 3825],
    Kericho: [3205, 3805],
  ...
  "Ridging (8ft)": {
    ...
    "Tana River": [488, 588],
    Lamu: [508, 608],
    "Taita Taveta": [465, 565],
    Garissa: [488, 588],
    Wajir: [520, 620],
    Mandera: [545, 645],
    Marsabit: [512, 612],
    Isiolo: [462, 562],
    "Tharaka-Nithi": [437, 537],
    Makueni: [434, 534],
    Nyandarua: [434, 534],
    Kirinyaga: [432, 532],
    "Murang'a": [431, 531],
  ...
  "Crown Wall Paint 20L": {
    ...
    Kwale: [4290, 4990],
    Kilifi: [4260, 4960],
    "Tana River": [4420, 5120],
    Lamu: [4580, 5280],
    "Taita Taveta": [4230, 4930],
    Garissa: [4420, 5120],
    Wajir: [4680, 5380],
    Mandera: [4900, 5600],
    Marsabit: [4640, 5340],
    Isiolo: [4180, 4880],
    "Tharaka-Nithi": [3960, 4660],
    Makueni: [3952, 4652],
    Nyandarua: [3950, 4650],
    Kirinyaga: [3945, 4645],
    "Murang'a": [3942, 4642],
    Turkana: [4952, 5652],
    "West Pokot": [4305, 5005],
    Samburu: [4380, 5080],
    "Trans-Nzoia": [4010, 4710],
    "Elgeyo-Marakwet": [4020, 4720],
    Nandi: [4005, 4705],
    Baringo: [4068, 4768],
    Laikipia: [4015, 4715],
    Kericho: [3998, 4698],
  ...
  "Sadolin Floor Paint 20L": {
    ...
    Kwale: [5100, 6100],
    Kilifi: [5060, 6060],
    "Tana River": [5250, 6250],
    Lamu: [5440, 6440],
    "Taita Taveta": [5020, 6020],
    Garissa: [5250, 6250],
    Wajir: [5560, 6560],
    Mandera: [5820, 6820],
    Marsabit: [5510, 6510],
    Isiolo: [4960, 5960],
    "Tharaka-Nithi": [4720, 5720],
    Makueni: [4706, 5706],
    Nyandarua: [4708, 5708],
    Kirinyaga: [4702, 5702],
    "Murang'a": [4699, 5699],
    Turkana: [5882, 6882],
    "West Pokot": [5120, 6120],
    Samburu: [5202, 6202],
    "Trans-Nzoia": [4762, 5762],
    "Elgeyo-Marakwet": [4775, 5775],
    Nandi: [4758, 5758],
    Baringo: [4835, 5835],
    Laikipia: [4768, 5768],
    Kericho: [4752, 5752],
  ...
  "Tile Adhesive 20kg": {
    ...
    "Tana River": [678, 818],
    Lamu: [704, 844],
    "Taita Taveta": [648, 788],
    Garissa: [678, 818],
    Wajir: [720, 860],
    Mandera: [755, 895],
    Marsabit: [712, 852],
    Isiolo: [645, 785],
    "Tharaka-Nithi": [612, 752],
    Makueni: [609, 749],
    Nyandarua: [608, 748],
    Kirinyaga: [605, 745],
    "Murang'a": [603, 743],
  ...
  "Tiles 60x60cm (Ceramic)": {
    ...
    Kwale: [2142, 3142],
    Kilifi: [2124, 3124],
    "Tana River": [2208, 3208],
    Lamu: [2288, 3288],
    "Taita Taveta": [2106, 3106],
    Garissa: [2208, 3208],
    Wajir: [2340, 3340],
    Mandera: [2450, 3450],
    Marsabit: [2318, 3318],
    Isiolo: [2092, 3092],
    "Tharaka-Nithi": [1960, 2960],
    Makueni: [1953, 2953],
    Nyandarua: [1952, 2952],
    Kirinyaga: [1948, 2948],
    "Murang'a": [1945, 2945],
    Turkana: [2475, 3475],
    "West Pokot": [2155, 3155],
    Samburu: [2192, 3192],
    "Trans-Nzoia": [2012, 3012],
    "Elgeyo-Marakwet": [2020, 3020],
    Nandi: [2005, 3005],
    Baringo: [2042, 3042],
    Laikipia: [2016, 3016],
    Kericho: [2002, 3002],
  ...
  "Tiles 30x30cm (Anti-slip)": {
    ...
    Kwale: [1436, 2036],
    Kilifi: [1422, 2022],
    "Tana River": [1480, 2080],
    Lamu: [1538, 2138],
    "Taita Taveta": [1414, 2014],
    Garissa: [1480, 2080],
    Wajir: [1570, 2170],
    Mandera: [1645, 2245],
    Marsabit: [1556, 2156],
    Isiolo: [1358, 1958],
    "Tharaka-Nithi": [1285, 1885],
    Makueni: [1278, 1878],
    Nyandarua: [1278, 1878],
    Kirinyaga: [1274, 1874],
    "Murang'a": [1271, 1871],
    Turkana: [1662, 2262],
    "West Pokot": [1445, 2045],
    Samburu: [1468, 2068],
    "Trans-Nzoia": [1306, 1906],
    "Elgeyo-Marakwet": [1310, 1910],
    Nandi: [1303, 1903],
    Baringo: [1328, 1928],
    Laikipia: [1308, 1908],
    Kericho: [1302, 1902],
  ...
  "Waterproofing Compound 5L": {
    ...
    Kwale: [1436, 1836],
    Kilifi: [1422, 1822],
    "Tana River": [1480, 1880],
    Lamu: [1538, 1938],
    "Taita Taveta": [1414, 1814],
    Garissa: [1480, 1880],
    Wajir: [1570, 1970],
    Mandera: [1645, 2045],
    Marsabit: [1556, 1956],
    Isiolo: [1358, 1758],
    "Tharaka-Nithi": [1285, 1685],
    Makueni: [1278, 1678],
    Nyandarua: [1278, 1678],
    Kirinyaga: [1274, 1674],
    "Murang'a": [1271, 1671],
    Turkana: [1662, 2062],
    "West Pokot": [1445, 1845],
    Samburu: [1468, 1868],
    "Trans-Nzoia": [1306, 1706],
    "Elgeyo-Marakwet": [1310, 1710],
    Nandi: [1303, 1703],
    Baringo: [1328, 1728],
    Laikipia: [1308, 1708],
    Kericho: [1302, 1702],
  ...
  "Skim Coat / Finishing Plaster": {
    ...
    "Tana River": [800, 1000],
    Lamu: [830, 1030],
    "Taita Taveta": [764, 964],
    Garissa: [800, 1000],
    Wajir: [848, 1048],
    Mandera: [888, 1088],
    Marsabit: [840, 1040],
    Isiolo: [752, 952],
    "Tharaka-Nithi": [712, 912],
    Makueni: [709, 909],
    Nyandarua: [708, 908],
    Kirinyaga: [706, 906],
    "Murang'a": [704, 904],
  ...
  "PVC Pipe 4 inch (6m)": {
    ...
    Kwale: [1640, 2040],
    Kilifi: [1628, 2028],
    "Tana River": [1690, 2090],
    Lamu: [1755, 2155],
    "Taita Taveta": [1618, 2018],
    Garissa: [1690, 2090],
    Wajir: [1795, 2195],
    Mandera: [1882, 2282],
    Marsabit: [1778, 2178],
    Isiolo: [1568, 1968],
    "Tharaka-Nithi": [1488, 1888],
    Makueni: [1480, 1880],
    Nyandarua: [1482, 1882],
    Kirinyaga: [1478, 1878],
    "Murang'a": [1475, 1875],
    Turkana: [1902, 2302],
    "West Pokot": [1652, 2052],
    Samburu: [1678, 2078],
    "Trans-Nzoia": [1508, 1908],
    "Elgeyo-Marakwet": [1512, 1912],
    Nandi: [1505, 1905],
    Baringo: [1530, 1930],
    Laikipia: [1510, 1910],
    Kericho: [1502, 1902],
  ...
  "PPR Pipe 20mm (4m)": {
    ...
    "Tana River": [456, 596],
    Lamu: [474, 614],
    "Taita Taveta": [435, 575],
    Garissa: [456, 596],
    Wajir: [486, 626],
    Mandera: [510, 650],
    Marsabit: [480, 620],
    Isiolo: [420, 560],
    "Tharaka-Nithi": [396, 536],
    Makueni: [393, 533],
    Nyandarua: [393, 533],
    Kirinyaga: [391, 531],
    "Murang'a": [390, 530],
  ...
  "Door Hinges 4 inch (pair)": {
    ...
    "Tana River": [213, 293],
    Lamu: [222, 302],
    "Taita Taveta": [202, 282],
    Garissa: [213, 293],
    Wajir: [226, 306],
    Mandera: [237, 317],
    Marsabit: [224, 304],
    Isiolo: [198, 278],
    "Tharaka-Nithi": [186, 266],
    Makueni: [184, 264],
    Nyandarua: [184, 264],
    Kirinyaga: [183, 263],
    "Murang'a": [183, 263],
  ...
  "Padlock 60mm": {
    ...
    "Tana River": [792, 1092],
    Lamu: [824, 1124],
    "Taita Taveta": [755, 1055],
    Garissa: [792, 1092],
    Wajir: [840, 1140],
    Mandera: [882, 1182],
    Marsabit: [832, 1132],
    Isiolo: [738, 1038],
    "Tharaka-Nithi": [685, 985],
    Makueni: [680, 980],
    Nyandarua: [680, 980],
    Kirinyaga: [677, 977],
    "Murang'a": [675, 975],
    ...
    "West Pokot": [774, 1074],
    Samburu: [787, 1087],
    "Trans-Nzoia": [706, 1006],
    "Elgeyo-Marakwet": [709, 1009],
    Nandi: [703, 1003],
    Baringo: [718, 1018],
    Laikipia: [707, 1007],
    Kericho: [702, 1002],
  ...
  "Electrical Cable 2.5mm (50m)": {
    ...
    Kwale: [4284, 5284],
    Kilifi: [4254, 5254],
    "Tana River": [4416, 5416],
    Lamu: [4578, 5578],
    "Taita Taveta": [4224, 5224],
    Garissa: [4416, 5416],
    Wajir: [4680, 5680],
    Mandera: [4900, 5900],
    Marsabit: [4640, 5640],
    Isiolo: [4180, 5180],
    "Tharaka-Nithi": [3960, 4960],
    Makueni: [3952, 4952],
    Nyandarua: [3952, 4952],
    Kirinyaga: [3947, 4947],
    "Murang'a": [3944, 4944],
    Turkana: [4952, 5952],
    "West Pokot": [4305, 5305],
    Samburu: [4380, 5380],
    "Trans-Nzoia": [4012, 5012],
    "Elgeyo-Marakwet": [4020, 5020],
    Nandi: [4005, 5005],
    Baringo: [4070, 5070],
    Laikipia: [4015, 5015],
    Kericho: [4002, 5002],
