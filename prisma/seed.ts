...
const MARKET_MATERIALS = [
    { name: "Bamburi Cement 50kg",          category: "Cement & Concrete", unit: "per bag"    },
    { name: "Savannah Cement 50kg",         category: "Cement & Concrete", unit: "per bag"    },
    { name: "East African Portland Cement", category: "Cement & Concrete", unit: "per bag"    },
    { name: "Ballast (20mm)",               category: "Cement & Concrete", unit: "per tonne"  },
    { name: "Concrete Blocks 6 inch",       category: "Cement & Concrete", unit: "per piece"  },
    { name: "Y8 Steel Rebar (6m)",          category: "Steel & Metal",     unit: "per piece"  },
    { name: "Y10 Steel Rebar (6m)",         category: "Steel & Metal",     unit: "per piece"  },
    { name: "Y12 Steel Rebar (6m)",         category: "Steel & Metal",     unit: "per piece"  },
    { name: "Y16 Steel Rebar (6m)",         category: "Steel & Metal",     unit: "per piece"  },
    { name: "BRC Mesh A142",                category: "Steel & Metal",     unit: "per sheet"  },
    { name: "Iron Sheets (28 gauge 8ft)",   category: "Steel & Metal",     unit: "per sheet"  },
    { name: "Galvanised Nails 4 inch",      category: "Steel & Metal",     unit: "per kg"     },
    { name: "Roofing Nails 3 inch",         category: "Steel & Metal",     unit: "per kg"     },
    { name: "River Sand",                   category: "Sand & Aggregates", unit: "per tonne"  },
    { name: "Quarry Dust",                  category: "Sand & Aggregates", unit: "per tonne"  },
    { name: "Hardcore",                     category: "Sand & Aggregates", unit: "per tonne"  },
    { name: "Crusher Run",                  category: "Sand & Aggregates", unit: "per tonne"  },
    { name: "3x2 Timber (12ft)",            category: "Timber & Roofing",  unit: "per piece"  },
    { name: "2x2 Timber (12ft)",            category: "Timber & Roofing",  unit: "per piece"  },
    { name: "Marine Plywood (18mm)",        category: "Timber & Roofing",  unit: "per sheet"  },
    { name: "Fascia Board (4m)",            category: "Timber & Roofing",  unit: "per piece"  },
    { name: "Crown Wall Paint 20L",         category: "Finishes & Paint",  unit: "per tin"    },
    { name: "Sadolin Floor Paint 20L",      category: "Finishes & Paint",  unit: "per tin"    },
    { name: "Tiles 60x60cm (Ceramic)",      category: "Finishes & Paint",  unit: "per sqm"    },
    { name: "Waterproofing Compound 5L",    category: "Finishes & Paint",  unit: "per tin"    },
    { name: "PVC Pipe 4 inch (6m)",         category: "Hardware & Fixings", unit: "per piece" },
    { name: "GI Pipe 1 inch (6m)",          category: "Hardware & Fixings", unit: "per piece" },
    { name: "Door Hinges 4 inch (pair)",    category: "Hardware & Fixings", unit: "per pair"  },
    { name: "Padlock 60mm",                 category: "Hardware & Fixings", unit: "per piece" },
];
    ...
    for (const [matName, countyPrices] of Object.entries(PRICE_DATA)) {
        ...
        for (const [countyName, range] of Object.entries(countyPrices)) {
            ...
            await prisma.countyMaterialPrice.upsert({
                ...
                update: { priceKes: mid(range), trend: trend(), updatedAt: new Date() },
                create: { materialId, countyId, sourceId, priceKes: mid(range), trend: trend() },
            });
            priceCount++;
        }
    }
