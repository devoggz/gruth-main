...
export const metadata: Metadata = {
    ...
    description: "Submit your verification request. We confirm availability and provide a quote within 2 business hours.",
};
...
export default async function RequestVerificationPage() {
    ...
    if (session?.user?.id) {
        userProfile = await prisma.user.findUnique({
            ...
            select: { id: true, name: true, email: true, phone: true, whatsapp: true, country: true },
        });
