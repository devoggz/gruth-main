          ...
          <div className="space-y-10">
            ...
            <div className="bg-orange-50 border border-orange-100 rounded-2xl p-6">
              <p className="text-charcoal-700 text-sm leading-relaxed m-0">
                ...
                carefully before using GRUTH. By accessing or using our
                platform, you agree to be bound by these Terms. If you do not
                agree, do not use GRUTH.
              </p>
            </div>

            <TermsSection title="1. The Service">
              <p>
                GRUTH provides on-the-ground verification services in Kenya. We
                dispatch trained field inspectors to visit locations, collect
                photographic and video evidence, and prepare structured written
                reports delivered through a secure client dashboard.
              </p>
              <p>
                GRUTH is an information and evidence service. Our reports
                reflect conditions observed at the time of inspection. We do not
                provide legal, architectural, engineering, or financial advice.
              </p>
            </TermsSection>
            ...
            <TermsSection title="2. Eligibility & Account">
              <p>
                ...
                legally binding agreement to use GRUTH. By registering, you
                confirm that the information you provide is accurate and up to
                date.
              </p>
              <p>
            ...
            <TermsSection title="3. Verification Requests">
              <p>When you submit a verification request, you agree to:</p>
            ...
            <TermsSection title="4. Fees & Payment">
              <p>
                Service fees are displayed at the time of request and are
                payable in advance unless otherwise agreed. Fees are
                non-refundable once an inspector has been dispatched, except in
                cases where we are unable to complete the inspection through no
                fault of the client.
              </p>
              <p>
                GRUTH reserves the right to update pricing at any time. Changes
                will not affect requests already submitted and paid.
              </p>
            </TermsSection>

            <TermsSection title="5. Reports & Deliverables">
              <p>
                Reports are provided for your personal and business use only.
                You may share your own reports with advisors, family members, or
                institutions for lawful purposes. You may not:
              </p>
              <ul className="space-y-2 text-charcoal-600 text-sm mt-3">
                {[
              ...
              <p>
                All reports are delivered within the timeframe stated at the
                time of request (typically 24–48 hours). Where circumstances
                prevent on-time delivery, we will notify you and agree a revised
                schedule.
              </p>
            </TermsSection>
            ...
            <TermsSection title="6. Limitation of Liability">
              <p>
                GRUTH reports reflect conditions as observed by field inspectors
                at the time of inspection. We make no guarantees as to future
                conditions, third-party conduct, or outcomes of transactions
                made in reliance on our reports.
              </p>
              <p>
                To the maximum extent permitted by law, GRUTH&apos;s total
                liability to you for any claim arising from use of our service
                is limited to the fees paid for the specific inspection giving
                rise to the claim.
              </p>
              <p>
            ...
            <TermsSection title="7. Acceptable Use">
              ...
              <p>
                ...
                suspension and, where applicable, referral to relevant
                authorities.
              </p>
            </TermsSection>
            ...
            <TermsSection title="8. Intellectual Property">
              <p>
                The GRUTH platform, brand, and all associated technology are our
                exclusive intellectual property. Inspection reports and evidence
                collected on your behalf remain your property once delivered,
                subject to the usage restrictions in Section 5.
              </p>
            </TermsSection>
            ...
            <TermsSection title="10. Governing Law">
              <p>
                ...
                Nairobi, Kenya, unless otherwise required by applicable consumer
            ...
            <TermsSection title="11. Changes to These Terms">
              <p>
                ...
                posted with a new &ldquo;Last updated&rdquo; date. Material
                changes will be communicated via email or in-app notification.
                Continued use of GRUTH after the effective date constitutes
