...
const SubmissionSchema = z.object({
  ...
  d => !d.priceLow || !d.priceHigh || d.priceLow <= d.priceHigh,
  { message: "priceLow must be ≤ priceHigh", path: ["priceLow"] }
);
...
export async function POST(req: NextRequest) {
  ...
  return NextResponse.json(
    {
      success:  true,
      message:  "Thank you — your submission will be reviewed before going live.",
      category,
      county:   county.name,
