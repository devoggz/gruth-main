    ...
    <div className="space-y-6 pb-12 overflow-hidden">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2 bg-emerald-50 border border-emerald-200 rounded-xl px-3.5 py-2">
          ...
          <span className="text-xs font-semibold text-emerald-700">GRUTH Verified</span>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-blue-100 bg-blue-50/70 px-4 py-3.5 flex gap-3 items-start">
        ...
        <p className="text-xs text-blue-700 leading-relaxed">
          <strong className="font-semibold">How to use this:</strong> Compare these market rates against
          contractor invoices. A markup of <strong>30%+</strong> above these figures is a red flag worth
