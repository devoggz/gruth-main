...
export const COUNTY_TIER_SURCHARGE: Record<
  ServicePricing["countyTier"],
  number
> = {
...
export const SERVICES: ServicePricing[] = [
  {
    ...
    emoji: "🏗️",
    description:
      "Site visit with photo/video evidence, material checks, progress vs plan report.",
    baseKes: 12_000,
    countyTier: "major",
  },
  {
    ...
    emoji: "🏡",
    description:
      "Boundary confirmation, beacon check, title deed cross-reference, occupancy status.",
    baseKes: 15_000,
    countyTier: "major",
  },
  {
    ...
    emoji: "💒",
    description:
      "On-ground agent for the event duration — real-time updates and photo/video relay.",
    baseKes: 18_000,
    countyTier: "major",
  },
  {
    ...
    emoji: "🕊️",
    description:
      "Respectful on-ground presence, progress reporting and confirmation of arrangements.",
    baseKes: 14_000,
    countyTier: "major",
  },
  {
    ...
    emoji: "📊",
    description:
      "Business premises visit, inventory check, staff confirmation, trading pattern review.",
    baseKes: 20_000,
    countyTier: "major",
  },
  {
    ...
    emoji: "🧱",
    description:
      "Verified market prices for specified materials from named suppliers in the county.",
    baseKes: 8_000,
    countyTier: "major",
  },
  {
    ...
    emoji: "📋",
    description:
      "Bespoke verification — price confirmed after project brief review.",
    baseKes: 12_000,
    countyTier: "major",
  },
];
