      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={headerRef} className="text-center mb-16 fade-up">
          ...
          <p className="text-charcoal-600 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
            The further away you are, the easier it is to be told what you want
            to hear. Everyone involved has something to gain from keeping you
            calm. We started GRUTH because we were that person abroad — sending
            money home, trusting the updates, hoping for the best. You deserve
            better than hope.
          </p>
        </div>
