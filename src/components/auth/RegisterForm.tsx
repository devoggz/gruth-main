                  ...
                  <form onSubmit={handleSubmit} noValidate className="space-y-3">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Solicitor / lawyer">Solicitor / lawyer</option>
                        <option value="Bank or remittance service">Bank or remittance service</option>
                    ...
                    {form.referralCode && (
                        <div className="flex items-center gap-2 bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-xs font-semibold text-emerald-800">Referral code applied</p>
                            <p className="text-[10px] text-emerald-600 font-mono">{form.referralCode}</p>
                          </div>
                          <button type="button" onClick={() => set("referralCode", "")}
