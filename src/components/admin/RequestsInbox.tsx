          ...
          <div className="space-y-1.5">
            {docs.map((f, i) => (
              ...
              >
                ...
                <svg
                  className="w-3.5 h-3.5 text-charcoal-300 group-hover:text-orange-400 flex-shrink-0 transition-colors"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
          ...
          <div className="flex items-start gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="mt-1.5 flex items-center gap-2 flex-wrap">
                ...
                {urgency && (
                  <span
                    className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${urgency.color}`}
                  >
                    {urgency.label}
                  </span>
                )}
          ...
          {isConverted && convertedProjectId ? (
            ...
            <div className="border border-charcoal-200 rounded-xl p-4 space-y-3">
              ...
              <p className="text-xs text-charcoal-500 leading-relaxed">
                Creates a live project + client account. Optionally assign an
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                      ...
                      {req.urgency && req.urgency !== "standard" && (
                        <span
                          className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${URGENCY_LABELS[req.urgency]?.color ?? ""}`}
                        >
                    ...
                    {images.length > 0 && (
                      <div className="flex items-center gap-1.5 mt-2">
                        {images.slice(0, 4).map((img, i) => (
                          <div
                            key={i}
                            className="relative w-8 h-8 rounded-lg overflow-hidden flex-shrink-0 bg-charcoal-100 border border-charcoal-200"
                          >
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                            <img
                              src={img.url}
