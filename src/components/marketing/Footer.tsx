        ...
        <div className="border-b border-white/[0.06] bg-white/[0.02]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-charcoal-400 text-xs text-center sm:text-left">
              <span className="text-white font-semibold">Refer a friend</span> who completes a verification →{" "}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="md:col-span-1">
              <Link href="/" className="inline-block mb-5">
                <Image src="/images/logo-w.svg" alt="GRUTH" width={140} height={40} />
              </Link>
              <p className="text-charcoal-400 text-sm leading-relaxed mb-5">
                Independent, on-the-ground verification for Kenyans abroad. Evidence you can trust, delivered to your dashboard in 48 hours.
              </p>
            ...
            {/* Services */}
            <div>
              <h4 className="font-semibold text-xs uppercase tracking-widest text-charcoal-400 mb-5">Services</h4>
            ...
            {/* Company */}
            <div>
              <h4 className="font-semibold text-xs uppercase tracking-widest text-charcoal-400 mb-5">Company</h4>
              <ul className="space-y-3 text-sm text-charcoal-500">
                {[
                  ["About Us",       "/about"],
            ...
            {/* Community */}
            <div>
              <h4 className="font-semibold text-xs uppercase tracking-widest text-charcoal-400 mb-5">Community</h4>
              <ul className="space-y-3 text-sm text-charcoal-500">
                {[
                  ["WhatsApp Channel",   "https://whatsapp.com/channel/gruth-kenya"],
          ...
          <div className="mt-12 pt-8 border-t border-charcoal-800 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-charcoal-500 text-xs">
              © {new Date().getFullYear()} GRUTH. All rights reserved. · Built by diaspora, for diaspora.
            </p>
